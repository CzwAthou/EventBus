    ...
    private boolean postSingleEventForEventType(Object event, PostingThreadState postingState, Class<?> eventClass) {
        ...
        if (subscriptions != null && !subscriptions.isEmpty()) {
            for (Subscription subscription : subscriptions) {
                ...
                if (event instanceof Intent) {
                    Intent intent = (Intent) event;
                    String action = intent.getAction();
                    if (!TextUtils.equals(action, subscription.subscriberMethod.action)) {
                        continue;
                    }
//                    if (!TextUtils.isEmpty(action)
//                            && !action.equals(subscription.subscriberMethod.action)
//                            || TextUtils.isEmpty(action)
//                            && !TextUtils.isEmpty(subscription.subscriberMethod.action)) {
//                        continue;
//                    }
                }
